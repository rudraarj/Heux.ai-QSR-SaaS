// notificationScheduler.js - Backend service for managing notification schedules
...
class NotificationScheduler {
    constructor() {
        ...
        this.triggerNotificationFn = null; // Store the function reference
    }
    ...
    generateCronExpression(notification) {
        ...
        if (notification.frequency === 'daily') {
            ...
            // Note: This is a simplified version. For true alternate days,
            // you might need additional logic to track last execution
    ...
    async executeNotification(notification) {
        try {
            ...
            // Update last triggered time in database (optional)
    ...
    stopAll() {
        ...
        console.log('All scheduled notifications stopped');
    }
}
